    ...
    <div :class="classes">
        ...
        <header v-if="!$root.isMobile" class="d-flex flex-wrap justify-content-center py-3 mb-3 border-bottom">
            ...
            >
                ...
                <span class="fs-4 title">{{ $t("Uptime Kuma Revanced") }}</span>
            </router-link>

            <a
                v-if="hasNewVersion"
                target="_blank"
                href="https://github.com/louislam/uptime-kuma-revanced/releases"
                ...
                <li v-if="$root.loggedIn" class="nav-item">
                    <div class="dropdown dropdown-profile-pic">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a
                                    href="https://github.com/louislam/uptime-kuma-revanced/wiki"
                                    class="dropdown-item"
                                    target="_blank"
                                >
        ...
        <header v-else class="d-flex flex-wrap justify-content-center pt-2 pb-2 mb-3">
            <router-link to="/dashboard" class="d-flex align-items-center text-dark text-decoration-none">
                ...
                <span class="fs-4 title ms-2">Uptime Kuma Revanced</span>
            </router-link>
        </header>
