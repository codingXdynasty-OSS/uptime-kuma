...
class Teams extends NotificationProvider {
    ...
    _notificationPayloadFactory = ({ heartbeatJSON, monitorName, monitorUrl, dashboardUrl }) => {
        ...
        if (dashboardUrl) {
            actions.push({
                type: "Action.OpenUrl",
                title: "Visit Uptime Kuma Revanced",
                url: dashboardUrl,
            });
        }
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        width: "32px",
                                                        style: "Person",
                                                        url: "https://raw.githubusercontent.com/louislam/uptime-kuma-revanced/master/public/icon.png",
                                                        altText: "Uptime Kuma Revanced Logo",
                                                    },
                                                ],
                                            },
                                            {
                                                ...
                                                items: [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        size: "Small",
                                                        weight: "Default",
                                                        text: "Uptime Kuma Revanced Alert",
                                                        isSubtle: true,
                                                        spacing: "None",
                                                    },
                                                ],
