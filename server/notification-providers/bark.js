...
const barkNotificationAvatar = "https://github.com/louislam/uptime-kuma-revanced/raw/master/public/icon.png";
...
class Bark extends NotificationProvider {
    ...
    additionalParameters(notification) {
        // set icon to Uptime Kuma Revanced icon, 11kb should be fine
