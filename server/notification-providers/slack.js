...
class Slack extends NotificationProvider {
     ...
     * @param {string} baseURL Uptime Kuma Revanced base URL
    ...
    buildActions(baseURL, monitorJSON) {
        ...
        if (baseURL) {
            actions.push({
                ...
                text: {
                    type: "plain_text",
                    text: "Visit Uptime Kuma Revanced",
                },
                value: "uptime-kuma-revanced",
    ...
    async send(notification, msg, monitorJSON = null, heartbeatJSON = null) {
        ...
        try {
            ...
            const title = monitorJSON?.name || "Uptime Kuma Revanced Alert";
            let data = {
                text: msg,
                channel: notification.slackchannel,
                username: notification.slackusername,
