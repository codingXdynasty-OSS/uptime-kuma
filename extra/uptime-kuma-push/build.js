...
const supportedPlatforms = [
    {
        name: "linux/amd64",
        bin: "./build/uptime-kuma-revanced-push-amd64",
    },
    {
        name: "linux/arm64",
        bin: "./build/uptime-kuma-revanced-push-arm64",
    },
    {
        name: "linux/arm/v7",
        bin: "./build/uptime-kuma-revanced-push-armv7",
    },
];
...
if (platformObj) {
    ...
    fs.renameSync(filename, "./uptime-kuma-revanced-push");
    process.exit(0);
} else {
