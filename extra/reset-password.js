console.log("== Uptime Kuma Revanced Reset Password Tool ==");
...
function disconnectAllSocketClients(username, password) {
    return new Promise((resolve) => {
        ...
        socket.on("connect_error", function () {
            // The localWebSocketURL is not guaranteed to be working for some complicated Uptime Kuma Revanced setup
