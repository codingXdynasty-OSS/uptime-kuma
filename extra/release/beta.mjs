...
if (!dryRun) {
    ...
    buildImage(
        ...
        "rootless",
        "BASE_IMAGE=louislam/uptime-kuma-revanced:base2-slim"
    );
    ...
    // Build slim image
    buildImage(repoNames, ["beta-slim", ver(version, "slim")], "release", "BASE_IMAGE=louislam/uptime-kuma-revanced:base2-slim");
